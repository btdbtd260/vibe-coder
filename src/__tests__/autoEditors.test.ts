...
describe('autoBuyEditors', () => {
  ...
  it('reserve percent blocks reserved money', () => {
    const s = makeState({ money: 100, autoEditors: { ...defaultState.autoEditors, enabled: true, moneyReservePct: 100 } });
    const result = autoBuyEditors(s);
